...
import { SUPPORTED_VIEW_ENGINES } from "../constants";
...
`;
    ...
    const indexContent = await generateDefaultHtmlTemplate(options);
...
async function generateDefaultHtmlTemplate(
  options: ResolvedOptions
): Promise<string> {
...
<body>
    ...
    <div class="text">
        ...
        <h2>Generated with ⚡ EXGEN CLI</h2>
        <h3>You're all set — your project structure is ready! </h3>
        <h3>Start building your backend with confidence.</h3>
    </div>
</body>
